## Purpose
Homebrew is a package manager for macOS and linux.  It lets you easily install, update, and manage software from the command line that doesn't come pre-installed on your Mac.
