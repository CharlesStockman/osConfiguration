...
### gh -- Command line client for interacting with GitHub.
|Command|Description|
|-------|-----------|
|echo "token generated by github" \| gh auth login --with-token | Log into your account |
|gh repo list | list all the repositories |
