...
04_Install_Stage_3.sh is not retrieving stage3 from the web.  The work around is to add the stage3 file to the boot drive and then the 04_Install_Stage_3.sh has been modified to work with that file.
...
|---------|-----------------------------------------------------------------------------------------------------------|--------------------------------------------|
| Basic   | Installs a basic linux system including kernel, boot loader, Terminal and timezone/language configuration | [ Basic Installation ](basicInstallation.md) |
...
<ol>
    ...
    <li>04_Install_Stage_3.sh is not able to download the latest stage3 compessed file which is a bug.  Can we generate this dynamically ?</i>
    <li>05_Modify_Make_Conf.sh</li>li>
